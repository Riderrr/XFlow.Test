...
Итог Example 1_2 выглядит более преспективным. Я бы добавил обработчик ошибок и присваивание дефолтных значений в случае ошибок сериализации JSON файлов
...
Сдесь я сгрупировал повораящийся код и вынес в оттдельные методы для удобства читаемости
